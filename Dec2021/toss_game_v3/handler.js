...
async function queryThisFromTheTable( query_str ){
  return new Promise( (resolve, reject) => {
    ...
    pool.query(query_str, function(err, result, fields) {
      ...
      if(err)
      {
          const errMsg = "[TossGameV3] [ERROR]: db-error:" + err;
          console.log(errMsg);
          reject(errMsg);
      }
...
*/                  
  ...
  */                                      
  ...
  return new Promise((resolve, reject) => {
      ...
      req.on('error', (e) => {
          console.log('[TossGameV3] @@@ :( [FCM Sending] failure' + e.message);
          reject(e.message);
      });
...
function sendPush_v03_forEndGame(event, token) {
  ...
  */                                      
  ...
  return new Promise((resolve, reject) => {
      ...
      req.on('error', (e) => {
          console.log('[TossGameV3] @@@_@@@ : For end game!: [FCM Sending] failure' + e.message);
          reject(e.message);
      });
...
module.exports.TossGameV3 = async (event) => {
...
//=========================================================================
  ...
  }else
  {
      ...
      const err_msg = "[TossGameV3]] [Serious Error!!] Abnormal turn number! "
  ...
  // 디버그용 로그
  console.logDebug("[TossGameV3] event: " + JSON.stringify(event) );
  console.logDebug("[TossGameV3] ##[INFO]## intGameStatus: " + intGameStatus + ", intGameIdx: " + intGameIdx + ", currentTurn: " + event.gameInfo.currentTurn );
...
if( intGameStatus < CONST_GAME_STATUS__END ) // 0==일단만들어짐(첫토스이전), 1==진행중, 2==완료, 3==드롭, 4==뭔가 문제? assign 바꿀려면, CreateGame쪽 코드도 같이 바꿔야.
{
  ...
  console.logDebug("[TossGameV3] ##[INFO]## nextUserId: " + strNextUserUid + ", intGameIdx: " + intGameIdx);
  ...
  if( intGameStatus == CONST_GAME_STATUS__START ) //if( event.gameInfo.progress == 0 ) //이제는 이값이 int. 2021.09.08.
  {
      ...
      {
        console.log("[TossGameV3] [Error] [GameTable] game status UPDATE FAIL. DB Access or etc.:  " + " > " + error);
  ...
  {
    console.log("[TossGameV3] [Error] [UserTable] SELECT FAIL. DB Access or etc.:  " + " > " + error);
    return sendRes(400, error);
  }
  ...
  {
    const err_msg = "[TossGameV3] [Error] [UserTable] There is NO such a user!";
    console.log(err_msg);
    return sendRes(402, err_msg);
  }
  if(queryResult.length > 1 )
  {
    const err_msg = "[TossGameV3] [Error] [UserTable] There are more than ONE user!";
    console.log(err_msg);
    return sendRes(402, err_msg);
  }
  ...
  // HERE!!!
  console.logDebug("[TossGameV3] ##[INFO 2]## a: " + event.gameInfo.currentTurn + ", b: " + event.finishedUsers[(event.gameInfo.currentTurn-2)].userIdx);
  ...
  {
    //console.log("[TossGameV3] [Error] [GameProgressTable] INSERT FAIL. 1 of 2. DB Access or etc.:  " + " > " + error);
    //console.log("[TossGameV3] [Error] [GameProgressTable] INSERT FAIL. 2 0f 2. gameIdx:  " + strGameIdx + " integered gameIdx: " + intGameIdx.toString() ); // 혹시모르니, gameIdx를 확인하자. str int 모두.
    console.log("[TossGameV3] [Error] [GameProgressTable] INSERT FAIL. 1 of 2. DB Access or etc. gameIdx: " + intGameIdx
                  + "  >> " + error);
    return sendRes(400, error);
  }
  ...
  {
    console.log("[TossGameV3] [Error] [GameCurrentTable] INSERT or UPDATE FAIL. DB Access or etc.:  " + " > " + error);
    return sendRes(400, error);
  }
  ...
  {
    console.log("[TossGameV3] [Error] [GameHistoryTable] INSERT or UPDATE FAIL. DB Access or etc.:  " + " > " + error);
    return sendRes(400, error);
  }
  ...
  try{
    ...
    console.logDebug("[TossGameV3] ### PUSH OK ###");
    return sendRes(200, pushResult);
    
    
    } catch(error) 
    {
      console.log( "[TossGameV3] [Error] ING. FCM Push FAIL!! " + error + ", FaildUserUid(nextUser): " + strNextUserUid);
...
//#########################################################################
  ...
  {
    //console.log("[TossGameV3] [Error] [GameProgressTable] The final user. INSERT FAIL. 1 of 3. DB Access or etc.:  " + " > " + error);
    //console.log("[TossGameV3] [Error] [GameProgressTable] The final user. INSERT FAIL. 2 of 3. gameIdx:  " + strGameIdx + " integered gameIdx: " + intGameIdx.toString() ); // 혹시모르니, gameIdx를 확인하자. str int 모두.
    //console.log("[TossGameV3] [Error] [GameProgressTable] The final user. INSERT FAIL. 3 of 3. The final userIdx:  " + intFinal_UserIdx ); 

    //console.log("[TossGameV3] [Error] [GameProgressTable] The final user. INSERT FAIL. 1 of 2. DB Access or etc.:  " + " > " + error);
    //console.log("[TossGameV3] [Error] [GameProgressTable] The final user. INSERT FAIL. 2 of 2. gameIdx: " + intGameIdx + ", The final userIdx: " + intFinal_UserIdx );
    const errStr = "[TossGameV3] [Error] [GameProgressTable] The final user. INSERT FAIL!! gameIdx: " + intGameIdx + ", The final userIdx: " + intFinal_UserIdx + ", error: " + error;
    console.log( errStr );
  ...
  {
    //console.log("[TossGameV3] [Error] [GameHistoryTable] The final user. INSERT or UPDATE FAIL. 1 of 2. DB Access or etc.:  " + " > " + error);
    //console.log("[TossGameV3] [Error] [GameHistoryTable] The final user. INSERT or UPDATE FAIL. 2 of 2. The final userIdx:  " + intFinal_UserIdx + ", gameIdx: " + intGameIdx); 
    const errStr = "[TossGameV3] [Error] [GameHistoryTable] The final user. INSERT or UPDATE FAIL. gameIdx: " + intGameIdx + ", The final userIdx: " + intFinal_UserIdx + ", error: " + error;
    console.log( errStr );
    return sendRes(400, errStr);
  }  
  //-------------------------------------------------------------------------
  ...
  try{
    ...
    //console.log("[TossGameV3] [Error] [GameCurrentTable] The final user. DELETE FAIL. 1 of 2. DB Access or etc.:  " + " > " + error);
    //console.log("[TossGameV3] [Error] [GameCurrentTable] The final user. DELETE FAIL. 2 of 2. gameIdx: " + intGameIdx); 
    const errStr = "[TossGameV3] [Error] [GameCurrentTable] The final user. DELETE FAIL. gameIdx: " + intGameIdx + ", error: " + error;
    console.log( errStr );
    return sendRes(400, errStr);
  }
  //-------------------------------------------------------------------------
  ...
  try{
    ...
    console.log("[TossGameV3] [Error] [GameProgressTable] The final user toss time. SELECT FAIL. 1 of 2. DB Access or etc.:  " + " > " + error);
    console.log("[TossGameV3] [Error] [GameProgressTable] The final user toss time. SELECT FAIL. 2 of 2. intProgressIdx: " + intProgressIdx); 
    return sendRes(400, error);
  }  
  ...
  try{
    ...
    console.log("[TossGameV3] [Error] [GameTable] End game update. UPDATE FAIL. 1 of 2. DB Access or etc.:  " + " > " + error);
    console.log("[TossGameV3] [Error] [GameTable] End game update. UPDATE FAIL. 2 of 2. gameIdx: " + intGameIdx); 
    return sendRes(400, error);
  } 
  !! 혹시나 지우지 말것. 2021.09.28 !!
  */
  ...
  try{
    ...
    //console.log("[TossGameV3] [Error] [GameTable] End game update. UPDATE FAIL. 1 of 2. DB Access or etc.:  " + " > " + error);
    //console.log("[TossGameV3] [Error] [GameTable] End game update. UPDATE FAIL. 2 of 2. gameIdx: " + intGameIdx); 
    const errStr = "[TossGameV3] [Error] [GameTable] End game update. UPDATE FAIL. gameIdx: " + intGameIdx + ", error: " + error;
    console.log( errStr );
    return sendRes(400, errStr);
  } 
  ...
  try{
    ...
    const errMsg = "[TossGameV3] [Error] [ScoreCountTable] INSERT FAIL or DB Access. gameIdx: " + intGameIdx +  " > "  + error;
    console.log(errMsg); 
  ...
  console.logDebug(multipleInsertStr);
  console.logDebug(multipleInsertStrForUnseen); // 5.6 용
  ...
  try{
    ...
    const errMsg = "[TossGameV3] [Error] [RatingStatusTable] INSERT FAIL or DB Access. gameIdx: " + intGameIdx +  " > "  + error;
    console.log(errMsg); 
    return sendRes(400, errMsg);
  }
  ...
  */
  ...
  try{
    ...
    const errMsg = "[TossGameV3] [Error] [UnseenTable] INSERT FAIL or DB Access. gameIdx: " + intGameIdx +  " > "  + error;
    console.log(errMsg); 
    return sendRes(400, errMsg);
  ...
  try{
    ...
    console.log( "[TossGameV3] [Error] Final For Loop. FCM Push FAIL!! " + error + ", gameIdx: " + intGameIdx);
    return sendRes(420, error);
  }
...
//=========================================================================
//#########################################################################
  const err_msg = "[TossGameV3] @@@###!!! [Serious Error!!] Dropped game or abnormal game! gameIdx: " + intGameIdx + ", status num: " + intGameStatus;
  console.log( err_msg );
  return sendRes(405, err_msg);
