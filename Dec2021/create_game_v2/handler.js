...
//
// 2021.12.14. sjjo. 기존의 v1을 v2로 변경. pool 방식으로 변경. 리스폰스 부분 최신 반영.
// 2021.12.31. sjjo. 스코어들을 미리 0으로 세팅해 놓기. 
//
//-------------------------------------------------------------------------------------
...
async function queryThisFromTheTable( query_str ){
  return new Promise( (resolve, reject) => {
    ...
    pool.query(query_str, function(err, result, fields) {
      ...
      if(err)
      {
          const errMsg = "[CreateGameV2] [ERROR]: db-error:" + err;
          console.log(errMsg);
          reject(errMsg);
      }
...
module.exports.CreateGameV2 = async (event) => {
...
//console.log(universal_date_string);
  ...
  try{
    ...
    */
    ...
    // 2021.11.09. const strINSERTed_GameIdx = nINSERTed_GameIdx.toString();// 2021.09.02 협의
    ...
    //-------------------------------------------------------------------------
      /*
      console.log("[CreateGameV2] [Error] 'createdTime' SELECT FAIL. DB Access or etc.:  " + " > " + error);
      return sendRes(400, error);        
      */
      const strErrMsg = "[CreateGameV2] [Error] 'createdTime' SELECT FAIL. DB Access or etc.:  " + " > " + error;        
    ...
    */
    ...
    const return_body = {
      gameInfo: {
        ...
        id: nINSERTed_GameIdx, /* strINSERTed_GameIdx, */
  ...
  }catch(error)
  {
    ...
    //-------------------------------------------------------------------------
    /*
    console.log("[CreateGameV2] [Error] INSERT FAIL. DB Access or etc.:  " + " > " + error);
    return sendRes(400, error);
    */
    
    const strErrMsg = "[CreateGameV2] [Error] INSERT FAIL. DB Access or etc.:  " + " > " + error;        
    console.log(strErrMsg);
    return sendRes(400, strErrMsg);  
