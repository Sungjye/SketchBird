...
//=========================================================================
  ...
  }else
  {
      ...
      const err_msg = "[TossGame]] [Serious Error!!] Abnormal turn number! "
  ...
  // 디버그용 로그
  console.log("[TossGame] ##[INFO]## intGameStatus: " + intGameStatus + ", intGameIdx: " + intGameIdx + ", currentTurn: " + event.gameInfo.currentTurn );
...
if( intGameStatus < CONST_GAME_STATUS__END ) // 0==일단만들어짐(첫토스이전), 1==진행중, 2==완료, 3==드롭, 4==뭔가 문제? assign 바꿀려면, CreateGame쪽 코드도 같이 바꿔야.
{
  ...
  console.log("[TossGame] ##[INFO]## nextUserId: " + strNextUserUid + ", intGameIdx: " + intGameIdx);
  ...
  // HERE!!!
  console.log("[TossGame] ##[INFO 2]## a: " + event.gameInfo.currentTurn + ", b: " + event.finishedUsers[(event.gameInfo.currentTurn-2)].userIdx);
  ...
  }catch(error)
  {
    ...
    console.log("[TossGame] [Error] [GameProgressTable] INSERT FAIL. 1 of 2. DB Access or etc. gameIdx: " + intGameIdx
                  + "  >> " + error);
    return sendRes(400, error);
  }
...
//#########################################################################
  ...
  }catch(error)
  {
    ...
    console.log("[TossGame] [Error] [GameProgressTable] The final user. INSERT FAIL. 1 of 2. DB Access or etc.:  " + " > " + error);
    console.log("[TossGame] [Error] [GameProgressTable] The final user. INSERT FAIL. 2 of 2. gameIdx: " + intGameIdx + ", The final userIdx: " + intFinal_UserIdx );
    return sendRes(400, error);
  }
  ...
  */
  ...
  try{
    ...
    const errMsg = "[TossGame] [Error] [ScoreCountTable] INSERT FAIL or DB Access. gameIdx: " + intGameIdx +  " > "  + error;
    console.log(errMsg); 
  ...
  try{
    ...
    const errMsg = "[TossGame] [Error] [RatingStatusTable] INSERT FAIL or DB Access. gameIdx: " + intGameIdx +  " > "  + error;
    console.log(errMsg); 
    return sendRes(400, errMsg);
  }
